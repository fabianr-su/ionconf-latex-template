...
In this template, the \textit{natbib} package is used together with the style \verb|\bibliographystyle{apalike}|. This matches the ION formatting guidelines very well while using BibTex. Use \verb|\citep{}| and \verb|\citet{}| as desired. \verb|\cite| defaults to \verb|\citet|.
