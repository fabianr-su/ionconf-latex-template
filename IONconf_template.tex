...
\author{
    First~Author, John~Doe\\Mystery~University
    \and Jane~Doe\\Unknown~Institution}
% author format for an example of three authors, where author 1 and 
% author 2 are from the same institution:
% \author{author#1~name, author#2~name\\author#1and#2~institution
% 	\and author#3~name \\ author#3~institution}
